package com.devd.microservices.springmicroservicessecurecli;
...
public class SpringMicroservicesSecurecliApplication implements CommandLineRunner{

	public static void main(String[] args) {
		SpringApplication.run(SpringMicroservicesSecurecliApplication.class, args);
	}
